	 ...
	 <div id="studentshow_box">
		  ...
		  ?>
		    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
              ...
              <tr>
                <td height="40" colspan="7"  bgcolor="#FFFFFF"><form name="form1" method="post" action="qjj.php">
                  <label>
                    <input type="hidden" name="uid" id="uid" value="<?php echo $_GET["id"];?>">
                    <input type="image" name="Submit" class="sub" src="images/jyzxyy.jpg">
                  </label>
                </form>
				<form name="form1" method="post" action="ordershow.php">
                  <label>
                    <input type="hidden" name="uid" id="uid" value="<?php echo $_GET["id"];?>">
                    <input type="submit" name="sub" class="order_show" value="直接预约该教员">
                  </label>
                </form>
				</td>
		  ...
		  ?>
		    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
              <tr>
                ...
                <td width="13%" align="center" bgcolor="#FFFFFF"><?php echo $classData['id'];?></td>
                <td width="13%" align="center" bgcolor="#f9f9f9"><b>姓名：</b></td>
                <td width="13%" align="center" bgcolor="#FFFFFF"><?php echo chgtitles($classData['name'],1); ?>教员</td>
