			        ...
			        <div id="tutor_box">
					  ...
					  <div id="tutor_box_center" style="width:668px; padding:1px; border:1px #f4f4f4 solid;">
						...
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                    中        <td width="137" height="30" align="right">真实姓名：</td>
                            <td colspan="5"><label>
                              <input name="truename" type="text" class="tutor_input" id="truename" onKeyPress="value=value.replace(/[^\u4E00-\u9FA5]/g,'')">
                          ...
                          <tr>
                            ...
                            <td width="122" align="right">出生年份：</td>
                            ...
                            <td width="100" align="right">目前学历：</td>
                            <td width="195"><select name="xueli" id="xueli">
                              <option>--请选择--</option>
          <?php
...
{  ?>
			  ...
			  ?>
                            ...
                            <td width="195"><select name="zhicheng" id="zhicheng">
                              <option>————请选择————</option>
                         	        <?php
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            ...
                            <td width="140"> <select name="quyu" id="quyu">
                              <option>--请选择--</option>
                                    <?php
$dir=$diaoquData["quyu"];
$split_dir = split ('[,.-]', $dir); //返回一个Array,你可以用for读出来
...
{  ?>
			  ...
			  ?>
                            ...
                            <td width="92" align="right">目前身份：</td>
