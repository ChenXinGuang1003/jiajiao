     ...
     <div id="xcrz_nr">
       <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
         ...
         <tr>
          ...
          <tr>
           <td height="40" align="center" bgcolor="#f9f9f9"><b>积分：</b></td>
           <td colspan="6" bgcolor="#FFFFFF" style="padding-left: 10px;">
		   <?php
           echo "总积分：".$total;
           echo'<br>';
           echo '其中：';
           echo'<br>';
           echo "注册积分：".$classData['reg_jifen']."分；";
           $reg_action='';
           if($classData['reg_action']==1){
               $reg_action='前台注册';
           }else{
               $reg_action='后台注册';
           }
           echo '（注册方式：'.$reg_action.'）；';
           echo'<br>';
		   echo "登录积分：".$classData['login_jifen']."分；";
		   echo "(共登录：".$classData['dlcs']."次，最近登录时间".$classData['zjtime'].")；";
           echo'<br>';
		   echo "认证积分为：".$classData['rz_jifen']."分；";
           echo'<br>';
           echo '会员积分：'.$classData['vip_jifen']."分（会员等级：".$classData['vip']."）；";
           echo'<br>';
           echo "已安排的订单积分：".$classData['success_jifen']."分；";
           echo'<br>';
           echo "手动更改积分：".$jifen."分；（<a href='reason.php'>更改原因</a>）";
		   ?>
		   
		   </td>
         </tr>
         <tr>
           <td height="40" colspan="7" align="center"  valign="middle" bgcolor="#FFFFFF">
               <a href="user_jlmod.php" style="display: inline-block;margin-top: 15px;"><img src="images/jlyl_01.jpg" width="137" height="50" /></a>
           </td>
         </tr>
       </table>
    </div>
