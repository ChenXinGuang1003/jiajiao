                          ...
                          <tr>
                            <td height="100" align="center"> <label>
                              <input name="jiesou" type="checkbox" id="jieshou" value="1" checked>
                                ...
                                我接受《才殊家教网教员注册协议》<B>（接受此项是成为才殊家教网教员的前提！）</B></td>
                          </tr>
                          <tr>
                            <td height="75" align="center"><label>
                              <input type="image" name="Submit" src="images/zjj_05.jpg" onClick="javascript:if(document.getElementById('jieshou').checked==false){alert('只有接受《才殊家教网教员服务协议》，才能注册为本站会员');return false;}">
                            </label>&nbsp;
                              <label>
