...
<div class="loginBox">
    ...
    <div class="loginMain">
    	<div class="loginMainMain">
            ...
            <img src="Code.php?act=captcha&amp;<?php echo mt_rand(); ?>" width="50" height="25" alt="CAPTCHA" border="1" onclick= "this.src=&quot;Code.php?act=captcha&amp;&quot;+Math.random()" style="cursor: pointer;" title="看不清，点击更换另一个验证码" /></li>
                <li class="btn"><input type="submit" class="loginBTN" height="40" value="" /><input type="reset" class="resetBTN" value="" /></li>
            </ul>
            </form>
        </div>
    </div>
...
<p class="js">&copy; &nbsp;技术支持:<a href="www.daxueshen.com" target="_blank">大学绅之家</a>&nbsp;&nbsp;<a href="www.nuoky.com" target="_blank">诺客文化</a></p>
</body>
</html>