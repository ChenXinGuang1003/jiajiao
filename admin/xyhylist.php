...
htqx("6.4");
	...
	if($bw->query($sql))
	{
		$bw->msg('处理成功!', 'xyhylist.php');	
	}else{
		$bw->msg('处理失败!', 'xyhylist.php');	
	}
}
...
<table width="96%" cellpadding="0" cellspacing="0">
  <tr class="trusername">
    ...
    <td width="114" align="center">是否显示</td>
  </tr>
...
?>
 <tr class="showtr">
    ...
    <td align="center"><?php if($list[$i]['isshow']=="2")
	 {
...
?>
  <tr>
  	<td colspan="15" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    	  <tr>
