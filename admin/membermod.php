...
if($action == 'insert')
{
	...
	unset($_POST['pages']);//翻页用的
	   ...
	   switch($ifxj){
		...
		$classData = $bw->selectOnly('*' ,'bw_member', 'id = '.$_POST['id']);
				
		$toatl_jifen=intval($classData['total_jifen']+$vip_jifen)-$classData['vip_jifen'];
					
				
		$sql34="update bw_member set total_jifen='".$toatl_jifen."', vip='".$vip."',vip_jifen='".$vip_jifen."',gzjl='".$_POST['gzjl']."',truename='".$_POST['truename']."',sex='".$_POST['sex']."',idcode='".$_POST['idcode']."',zhrzxx='".$_POST['zhrzxx']."',xuexiao='".$_POST['xuexiao']."',xueli='".$_POST['xueli']."',csd='".$_POST['csd']."',quyu='".$_POST['quyu']."',telphone='".$_POST['telphone']."',email='".$_POST['email']."',qq='".$_POST['qq']."',address='".$_POST['address']."',ifrz='".$_POST['ifrz']."',daoqi='".$_POST['daoqi']."',ifxj='".$_POST['ifxj']."',jiaolin='".$_POST['jiaolin']."',mqsf='".$_POST['mqsf']."',zhicheng='".$_POST['zhicheng']."',rzxxlb='".$_POST['rzxxlb']."',rjxk='".$_POST['rjxk']."',jifen='".$_POST['jifen']."',xxly='".$_POST['xxly']."',kjskm='".$_POST['kjskm']."',zwms='".$_POST['zwms']."',kskqy='".$_POST['kskqy']."',kfdfs='".$_POST['kfdfs']."',ksksj='".$_POST['ksksj']."',xsyq='".$_POST['xsyq']."',iffb='".$_POST['iffb']."',ifzc='".$_POST['ifzc']."',iftj='".$_POST['iftj']."',lang='".$_POST['lang']."' where id='".$_POST['id']."'";
		if($bw->query($sql34))
...
{  ?>
  ...
  <tr>
    ...
    <td><input type="text" name="jifen" id="jifen" value="<?php echo $newsData['jifen']; ?>" /></td>
    </tr>
    <td align="right">信息来源;</td>
    <td align="left"><input type="text" name="xxly" id="xxly" value="<?php echo $newsData['xxly']; ?>" /></td>
  </tr>
  <tr>
...
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="right">身份证：</td>
    <td><input name="idcode" type="text"  id="idcode" value="<?php echo $newsData['idcode'];?>" /></td>
    <td align="right">任职学校：</td>
    <td><input type="text" name="zhrzxx" id="zhrzxx" value="<?php echo $newsData['zhrzxx']; ?>" /></td>
    <td align="right">学校：</td>
...
{  ?>
  ...
  <tr>
    ...
    <td align="right">信息来源</td>
    <td><input type="text" name="xxly" id="xxly" value="<?php echo $newsData['xxly']; ?>" /></td>
  </tr>
  <tr>
    <td align="right">可教授科目：</td>
    <td colspan="7" align="left"><table width="548" border="0" align="left" cellpadding="0" cellspacing="0">
