...
if($action=="yes")
{
	...
	if(empty($id))
	{
		...
		unset($_POST['Submit2']);
		unset($_POST['id']);
		// 增加学员姓名重复判断 by 昌维 2016-10-30 10:53:17
		if ($bw->sum($bw->query("select * from bw_qjj where `name`='".$_POST['name']."'"))>0) {
			$bw->msg('新增失败!学员姓名重复', 'xyadd.php?id='.$id.'', true);
      		return;
		}
		...
		//insert($tbName, $post)
		$_POST['password'] = '49ba59abbe56e057'; // 初始密码123456 by 昌维 2016-10-30 12:24:50
		$_POST['hits'] = '0'; // 初始hits by 昌维 2016-10-30 12:24:50
