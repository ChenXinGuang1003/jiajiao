...
htqx("8.4");
	...
	if(isset($_POST['id']))
	{
		...
		if(!empty($_POST['deleteSelect']))
		{
			...
			$sql = "UPDATE bw_member SET is_delete = 1 WHERE id IN (".$id.")";
...
<?php
  ...
  $pageSize = PAGESIZE;
  $tbName   = "bw_member";
  $where    = 'lang="'.$Lang.'" and is_delete <> 1 ';
  //搜索
  ...
  // var_dump($_SESSION['wherejflist'].' and is_delete != 1');
  // return;
  //die($_SESSION['wherejflist']);
  $_SESSION['wherejflist'] = $_SESSION['wherejflist'].' and is_delete != 1';
