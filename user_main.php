...
<div class="user_right">
  ...
  <tr>
	...
	<a href="zxzf_zfb.php?acontent=1" target="_blank"><font color="#FF6600">马上充值?</font></a><a href="yetojf.php" target="_blank">余额兑换积分</a></td>
    <td bgcolor="#FFFFFF">账户积分：<?php echo $total_jifen."分";?><a href="jftoye.php" target="_blank"><font color="#FF6600">积分兑换余额</font></a></td>
