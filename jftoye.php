...
<div class="user_right">
    ...
    <div id="xcrz_nr">
      ...
      <form action="jifentoye.php" method="post">      
	  <tr>
          <td width="746" height="30" align="left" valign="middle" bgcolor="#F1F1F1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 账户积分</td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF"><table width="746" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="503" height="50" align="left" valign="middle">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <font style="font-size:16px; font-weight:bold"><? echo $total_jifen; ?></font>&nbsp; 积分  兑换余额比例是<?php echo $bili; ?>：1
			  
			   </td>
			   <td><input type="text" name="jifen" placeholder="输入相应的积分"></td>
