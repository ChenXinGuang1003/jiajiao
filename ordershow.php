...
<div id="all_main_all">
	 ...
	 <div id="studentshow_box">
		  ...
		  ?>
			...
			<form name="form1" method="post"  class="order_Form" action="order_recive.php">
                  <label>
                    <input type="hidden" name="jyid" id="uid" value="<?php echo $classData['id'];?>">
                    <input type="submit" name="Submit" class="sub" value="确定">
                  </label>
                </form>
				<a class="online">返回</a>
				</td>
