...
<div id="all_main_all">
	 ...
	 <div id="all_main_all_box">
	      <div id="all_main_all_box_left">
		       <div id="all_main_all_box_left_top"><b style="font-size:16px; color:#fe5009;">学员注册</b>&nbsp;&nbsp;&nbsp;当前位置：学员注册</div>
			   <div id="all_main_all_box_left_mid">
			        <div id="tutor_box">
				      <div id="title" style="width:670px; height:36px; padding:1px;">
					       <div style="width:655px; height:36px; background:#f4f4f4; padding-left:15px;"> <strong>学员注册第二步:</strong><font color="#fe5d08">1</font>请务必填写真实姓名，与证件不符者将不能通过认证。<font color="#fe5d08">2</font>为保护您的隐私，本网不会公开显示您的姓名</div>
					  </div>
					  <div id="tutor_box_center" style="width:668px; padding:1px; border:1px #f4f4f4 solid;">
					    <form action="tutor_stuinfo1.php" onSubmit="return zhuce();" method="post" id="reg_from">
						...
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td><label>
                              ...
                              <input type="button" name="button" id="button" value="用户名检测" onClick="javascript:openwin('stu_jiance.php?uname='+document.getElementById('username').value)">
