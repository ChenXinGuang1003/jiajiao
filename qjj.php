               ...
               <div id="left">
			        <div class="box">
						 ...
						 <div class="nr">
							  ...
							  <br>
							 或QQ联系：<b>刘老师</b>&nbsp;<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3023810971&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:3023810971:52" alt="刘老师" title="刘老师"/></a> 
                             &nbsp; <b>张老师：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3426768747&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:3426768747:52" alt="张老师" title="张老师"/></a>
							 <br> 
				    ...
				    <div class="box">
						 ...
						 <div class="nr">
							  ...
							  <div class="bot">
							  在线预约：您可以直接进入<a href="teachers.php" style="color:#F90; font-size:14px;">教员库</a>找到你中意的教员后，记下教员的教员编号，通过拨打客服热线或者在线QQ，预约此教员。
							  </div>
						 </div>
					</div>
			   </div>
					  ...
					  <form name="form1" method="post" action="?action=add">
					    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td colspan="2"><label>
                              <textarea name="qtyq" rows="5" id="qtyq" style="width:248px; border:1px #CCCCCC solid; color:#666666;"onfocus="if(value=='比如：1.学员性别、上课时间、上课地点 2.要求安排教员性别 3.每周上多少次') {value=''}" onBlur="if (value=='') {value='比如：1.学员性别、上课时间、上课地点 2.要求安排教员性别 3.每周上多少次'}">比如：1.学员性别、上课时间、上课地点 2.要求安排教员性别 3.每周上多少次</textarea>
                            </label></td>
                          </tr>
                          <tr>
