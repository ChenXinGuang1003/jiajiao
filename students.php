...
<div id="students_main">
     <div id="students_main_header">
	      <div id="top">
		       <div id="left"  style="background:url(images/xytitile.png) no-repeat left center;padding-left:60px;">学员库<span>Student library</span></div>
			   <div id="right">
			   <span style="float:left; margin-left:270px; margin-top:2px; color:#90805c; font-size:42px"><?php echo $service_bphone; ?></span>
			   </div>
		  </div>
		   <div id="bot">
				...
				<div class="lctwo" style=" margin-left:30px;">
					 <div class="lctwo_mid">
						  <div class="lctwo_mid_nr">说明：<a href="articleshow.php?id=103" target="_blank"><font color="#fff000">含代收学员会员费</font></a></div>
					 </div>
					 <div class="lctwo_bot"></div>
				</div>
				<div class="lctwo"  style=" margin-left:45px;">
					 <div class="lctwo_mid">
						  <div class="lctwo_mid_nr">①在线申请订单②本站推荐订单</div>
					 </div>
					 <div class="lctwo_bot"></div>
				</div>
				<div class="lctwo"  style=" margin-left:40px;">
					 <div class="lctwo_mid">
                    ...
                    <div class="lctwo" style=" margin-left:30px;">
					 <div class="lctwo_mid">
						  <div class="lctwo_mid_nr">如果您还没成为教员,请点击<a href="tutor.php"><font color="#fff000">注册</font></a></div>
					 </div>
					 <div class="lctwo_bot"></div>
				</div>
                
                <div class="lctwo" style=" margin-left:22px;">
					 <div class="lctwo_mids">
						  <div class="lctwo_mid_nrs">①试教成功,核实扣款<br>
②试教失败,申请退款</div>
					 </div>
		    ...
		    <form name="form1" method="post" action="?action=search">
			  ...
			  <tr>
				<td width="780" align="left">
				    &nbsp;订单编号：
				    <input name="ddbh" type="text" id="ddbh" size="8">
